...
{ // begin of form
		...
		try
		{
			...
			frame.setBounds(0,0,screenSize.width,screenSize.height);
		    	...
		    	frame.getRootPane().setWindowDecorationStyle(JRootPane.NONE);
                        img = new JLabel("");
                        img.setIcon(new ImageIcon("p5.jpg"));
		    	frame.setVisible(true);
		   	lblHeading = new JLabel("The Vehicle Damage Detail");
	...
	private static void prepare_table_data()
	{
		...
		try
		{
			...
			Statement stmt1 = con.createStatement();
	        	...
	        	String sql = "select  acc_year,damaged, total, damagelevel from vehicleinfo";
	    		...
	    		while (res.next()) 
			{
				...
				newrow.addElement(res.getObject("acc_year"));
                                newrow.addElement(res.getObject("damaged"));
				newrow.addElement(res.getObject("total"));
                                newrow.addElement(res.getObject("damagelevel"));
	...
	private static void display_data_in_table()
	{
		...
		cname.addElement("acc_year");
               ...
               // Vector cname = new Vector();
                cname.addElement("damaged");
		cname.addElement("total");
		cname.addElement("damagelevel");
...
public static void main(String s[]) 
{
    javax.swing.SwingUtilities.invokeLater(new Runnable() 
   {
	 public void run() 
	{
		display6_hive h=new display6_hive();
		h.createAndShowGUI();
	}
});
