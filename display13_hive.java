	...
	{ //begin of createAndShowGUI method
		try
		{
			...
			frame.setBounds(0,0,screenSize.width,screenSize.height);
		   	...
		   	lblHeading = new JLabel("The prediction of accidents ratio in 2017");
img = new JLabel("");
img.setIcon(new ImageIcon("g2.png"));
			...
			lblHeading.setFont(new Font("Comic Sans MS", Font.ITALIC, 25));
addComponentToPane(frame.getContentPane(),img,120,100,2500,100);
                         img.setForeground(Color.red);
			addComponentToPane(frame.getContentPane(),lblHeading,90,50,0,0);
	...
	private static class myAction implements ActionListener
	{
		public  void actionPerformed(ActionEvent e) 
		{
			...
			{	System.out.println("hello");
				...
				addComponentToPane(frame.getContentPane(),scrollData,350,150,-380,-340);
	...
	private static void prepare_table_data()
	{
		...
		try
		{
			...
			Statement stmt1 = con.createStatement();
	        	String tableName ="r3";
	        	String sql = "select prediction  from r3";
	    		...
	    		while (res.next()) 
			{
				...
				newrow.addElement(res.getObject("prediction"));
	...
	{
		prepare_table_data();
		String colNames[]={"prediction"};
		Vector cname = new Vector();
		cname.addElement("prediction");
...
public static void main(String s[]) 
{
    javax.swing.SwingUtilities.invokeLater(new Runnable() 
   {
	 public void run() 
	{
		display13_hive h=new display13_hive();
		h.createAndShowGUI();
	}
 });
