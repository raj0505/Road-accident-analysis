	...
	{ //begin of createAndShowGUI method
		try
		{
			...
			frame.setBounds(0,0,screenSize.width,screenSize.height);
		   	...
		   	lblHeading = new JLabel("The prediction of accidents ratio in 2016");
img = new JLabel("");
	...
	private static void prepare_table_data()
	{
		...
		try
		{
			...
			Statement stmt1 = con.createStatement();
	        	String tableName ="r2";
	        	String sql = "select prediction from r2";
...
public static void main(String s[]) 
{
    javax.swing.SwingUtilities.invokeLater(new Runnable() 
   {
	 public void run() 
	{
		display12_hive h=new display12_hive();
		h.createAndShowGUI();
	}
 });
