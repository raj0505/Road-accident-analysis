	...
	{ //begin of createAndShowGUI method
		try
		{
			...
			frame.setBounds(0,0,screenSize.width,screenSize.height);
		   	...
		   	lblHeading = new JLabel("The prediction of accidents ratio in 2020");
img = new JLabel("");
img.setIcon(new ImageIcon("g4.png"));
	...
	private static void prepare_table_data()
	{
		...
		try
		{
			...
			Statement stmt1 = con.createStatement();
	        	String tableName ="r6";
	        	String sql = "select prediction from r6";
...
public static void main(String s[]) 
{
    javax.swing.SwingUtilities.invokeLater(new Runnable() 
   {
	 public void run() 
	{
		display16_hive h=new display16_hive();
		h.createAndShowGUI();
	}
 });
