		...
		try
		{
			...
			frame.setBounds(0,0,screenSize.width,screenSize.height);
		    	...
		    	frame.getRootPane().setWindowDecorationStyle(JRootPane.NONE);
                        img = new JLabel("");
                      img.setIcon(new ImageIcon("p3.jpg"));
		    	frame.setVisible(true);
		   	lblHeading = new JLabel("Month Wise Detail Of Accident");
			...
			addComponentToPane(frame.getContentPane(),btnExit,340,500,20,18,"exit");
                        addComponentToPane(frame.getContentPane(),img,-100,100,-200,-100);
		}
		catch(Exception e)
		{
	...
	private static void prepare_table_data()
	{
		...
		try
		{
			...
			Statement stmt1 = con.createStatement();
	        	String tableName ="monthdetail";
	        	String sql = "select  acc_year,injured,killed,not_injured from monthdetail";
...
public static void main(String s[]) 
{
    javax.swing.SwingUtilities.invokeLater(new Runnable() 
   {
	 public void run() 
	{
		display5_hive h=new display5_hive();
		h.createAndShowGUI();
	}
});
