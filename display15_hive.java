	...
	{ //begin of createAndShowGUI method
		try
		{
			...
			frame.setBounds(0,0,screenSize.width,screenSize.height);
		   	...
		   	lblHeading = new JLabel("The prediction of accidents ratio in 2019");
img = new JLabel("");
img.setIcon(new ImageIcon("g3.png"));
	...
	private static void prepare_table_data()
	{
		...
		try
		{
			...
			Statement stmt1 = con.createStatement();
	        	String tableName ="r5";
	        	String sql = "select prediction from r5";
...
public static void main(String s[]) 
{
    javax.swing.SwingUtilities.invokeLater(new Runnable() 
   {
	 public void run() 
	{
		display15_hive h=new display15_hive();
		h.createAndShowGUI();
	}
 });
